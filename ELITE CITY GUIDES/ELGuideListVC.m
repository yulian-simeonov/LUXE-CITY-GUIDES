...
@interface ELGuideListVC () <UITableViewDataSource, UITableViewDelegate>
...
- (void)getList
{
    if ([self.guideType isEqualToString:@"Accommodation"])
    {
        self.guideSets = [ELAppData appData].accommodationArray;
    }
    else if ([self.guideType isEqualToString:@"Activities"])
    {
        self.guideSets = [ELAppData appData].activitiesArray;
    }
    else if ([self.guideType isEqualToString:@"BarsClubs"])
    {
        self.guideSets = [ELAppData appData].barsClubsArray;
    }
    else if ([self.guideType isEqualToString:@"Dining"])
    {
        self.guideSets = [ELAppData appData].diningArray;
    }
    else if ([self.guideType isEqualToString:@"Shopping"])
    {
        self.guideSets = [ELAppData appData].shoppingArray;
    }
    else if ([self.guideType isEqualToString:@"SpaBeauty"])
    {
        self.guideSets = [ELAppData appData].spaBeautyArray;
    }
}
...
{
    return self.view.frame.size.width * 0.53 + 80;
}
